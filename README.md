...
- **mc\_rtc\_ticker** provides an RViz display.launch configuration with the above panel.

## Tools moved to mc_rtc

These tools used to be part of this ROS package but have now been moved to mc_rtc and are available as standalone executables.
...
- **mc\_rtc\_ticker** the open-loop ticker controller is now part of mc_rtc
